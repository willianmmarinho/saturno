...
@section('content')
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">Novo Depósito</div>
            <div class="card-body">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="largura" id="id_largura" step="0.01" min="0"
                                class="form-control @error('largura') is-invalid @enderror" value="{{ old('largura') }}"
                                required>
                            @error('largura')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="altura" id="id_altura" step="0.01" min="0"
                                class="form-control @error('altura') is-invalid @enderror" value="{{ old('altura') }}"
                                required>
                            @error('altura')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="largura_porta" id="id_largura_porta" step="0.01" min="0"
                                ...
                                value="{{ old('largura_porta') }}" required>
                            @error('largura_porta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="altura_porta" id="id_altura_porta" step="0.01" min="0"
                                ...
                                value="{{ old('altura_porta') }}" required>
                            @error('altura_porta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
